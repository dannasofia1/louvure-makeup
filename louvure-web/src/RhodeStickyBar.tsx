/**
 * RhodeStickyBar — Replica de la barra flotante de Rhode Skin
 *
 * USO:
 *   <RhodeStickyBar
 *     product={{
 ...
 *       shades: ["Unscented", "Glazed Donut", "Espresso Haze"],  // opcional
 *     }}
 *     showAfterScroll={300}   // px de scroll para aparecer (default: 300)
 *     onAddToCart={(shade) => console.log("Añadido:", shade)}
 *   />
 */
